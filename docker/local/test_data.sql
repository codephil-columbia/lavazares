...
CREATE FUNCTION start() RETURNS void AS $$
    DECLARE
        ...
        chapter_6 TEXT := '7';
    BEGIN
            INSERT INTO chapters (chapterid, chaptername, chapterdescription, nextchapterid)
            VALUES 
                -- Chapter Info -- 
                (chapter_0, 'Chapter 0: The Basics', 'In this chapter, you will learn the importance of touch typing as well as proper posture while using the keyboard. You will also encounter the entire finger map of the keyboard, which will serve as your guidelines for the rest of the tutorial.', chapter_1),
                (chapter_1, 'Chapter 1: Home Row', 'In this chapter, you will learn how to use the home row, which is located on the center of the keyboard. Home row is where you will start your typing journey.', chapter_2),
                (chapter_2, 'Chapter 2: Shift and Basic Punctuations', 'In this chapter, you will learn how to use the ''Shift'' keys, which are located on both sides of the keyboard. The ‘Shift’ keys will allow you to access common punctuations. ', chapter_3),
                (chapter_3, 'Chapter 3: Top Row', 'In this chapter, you will learn how to use the top row, which is located above the home row. Mastering the top row allows you to access all English vowels.', chapter_4),
                (chapter_4, 'Chapter 4: Bottom Row', 'In this chapter, you will learn how to use the bottom row, which is located below the home row. You have already encountered some of the bottom row keys in Chapter 2, but this chapter will complete your understanding of the bottom row.', chapter_5),
                (chapter_5, 'Chapter 5: Number Row', 'In this chapter, you will learn how to use the number row. The number row is important for performing math operations. This chapter will complete your keyboard knowledge.', chapter_6),
                (chapter_6, 'Chapter 6: Advanced Content', 'The final chapter of the tutorial will include advanced training exercises. This will bring your WPM and accuracy to the next level, by providing practices through common words, sentences, and paragraphs.', null);
            ...
            INSERT INTO lessons (lessonname, lessontext, lessonid, chapterid, minimumscoretopass, lessondescriptions, image, nextlessonid)
